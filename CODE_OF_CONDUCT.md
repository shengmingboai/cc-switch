...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement by opening a private report through the project's [GitHub Security Advisories](https://github.com/shengmingboai/cc-switch/security/advisories/new). All complaints will be reviewed and investigated promptly and fairly.
...
辱骂、骚扰或其他不可接受的行为可通过项目的 [GitHub 安全公告](https://github.com/shengmingboai/cc-switch/security/advisories/new) 以私密报告的形式向负责监督的社区领袖报告。所有投诉都将得到及时和公平的审查和调查。
