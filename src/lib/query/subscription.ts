 ...
 *
 * 直接以 ai-switch 自管的 ChatGPT 账号 ID 查询额度，供供应商卡片等按账号
 ...
 *
 * 与 `useSubscriptionQuota` 平行：数据走 ai-switch 自管的 OAuth token，
 ...
 *
 * 与 `useCodexOauthQuota` 平行：数据走 ai-switch 自管的 xAI OAuth token，
