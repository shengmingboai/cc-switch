...
/// User-Agent
const CODEX_USER_AGENT: &str = "ai-switch-codex-oauth";
...
struct CodexAccountData {
    ...
    /// ai-switch 都可能轮换 refresh_token 时拒绝从 live 采纳更旧的一代。
    #[serde(default)]
...
impl CodexOAuthManager {
    ...
    /// CLI does not participate in ai-switch's switch lock and may refresh in
