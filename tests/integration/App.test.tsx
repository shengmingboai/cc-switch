...
describe("App integration with MSW", () => {
  beforeEach(() => {
    ...
    localStorage.removeItem("ai-switch-last-view");
    localStorage.removeItem("ai-switch-last-app");
  });
  ...
  it("warns without blocking when removing Pi's global default provider", async () => {
    localStorage.setItem("ai-switch-last-app", "pi");
    setProviders("pi", {
      custom: {
        id: "custom",
        name: "Custom Pi",
  ...
  it("hosts the Skills check-update action in the App toolbar", async () => {
    localStorage.setItem("ai-switch-last-view", "skills");
    const { default: App } = await import("@/App");
    renderApp(App);
