...
### Claude Code、Claude Desktop、Codex、Grok Build、OpenCode 和 Pi 的全方位管理工具
...
CC Switch 支持六个工具：**Claude Code**、**Claude Desktop**、**Codex**、**Grok Build**、**OpenCode** 和 **Pi**。每个工具都有专属的供应商预设和配置管理。
