...
### The All-in-One Manager for Claude Code, Claude Desktop, Codex, Grok Build, OpenCode & Pi
...
CC Switch supports six tools: **Claude Code**, **Claude Desktop**, **Codex**, **Grok Build**, **OpenCode**, and **Pi**. Each tool has dedicated provider presets and configuration management.
