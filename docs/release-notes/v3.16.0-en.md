...
### Historical Locale Expansion

This release originally added Traditional Chinese UI localization and a German README (#3093 and #2994). Those locales have since been removed; current builds and documentation retain Chinese and English only.
