...
Only download CC Switch from **[GitHub Releases](https://github.com/shengmingboai/cc-switch/releases)** or the project source repository. Any "CC Switch" site or client that asks for payment, top-ups, or login credentials is not official.
...
1. Visit the [Releases page](https://github.com/shengmingboai/cc-switch/releases)
