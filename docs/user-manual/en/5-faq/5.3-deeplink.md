...
## Local Generator Tool

The repository ships a local deep link generator at the root level: `deplink.html`. Clone the repository and open that file in a browser to generate deep links, no network required:

**File location**: `deplink.html` in the repository root

### How to Use

1. Clone the repository and open `deplink.html` in a browser
